...
import { adminNavigate } from "../../_components/adminNavigate";
import { resetCagnotte } from "../../actions";
import type { StructuresFiltreProps } from "./types";
      ...
      <Reveal delay={0}>
        <div>
          ...
          <p className="text-sapin/80 mt-2">
            Gérez les comptes commerçants et associations de la plateforme.
          </p>
        </div>
      </Reveal>
                ...
                <Reveal key={a.id_association} delay={i * 0.08}>
                  <AdminProfileCard
                    ...
                    details={[
                      ...
                      {
                        label: "Cagnotte",
                        value: a.cagnotte.toLocaleString("fr-FR", {
                          style: "currency",
                          currency: "EUR",
                        }),
                      },
          ...
          >
            <Pagination
              ...
              totalPages={Math.ceil(
                Math.max(commercantsTotal, associationsTotal) / pageSize,
              )}
              goToPage={(p) => go("all", p)}
            />
          </motion.div>
